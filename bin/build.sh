...
claymate build \
  ...
  --files public/bower_components/gumby/js/plugins.js,public/bower_components/gumby/js/main.js,public/bower_components/jquery.easing/js/jquery.easing.js,public/scripts/custom.js
