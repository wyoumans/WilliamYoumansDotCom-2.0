...
module.exports = function() {
  return function(req, res, next) {
    ...
    res.locals.metaDescription = 'The technical portfolio of William Youmans, a Charlotte, North Carolina based freelance web developer, technical project manager, and software consultant.';
    res.locals.browserTitle = 'Freelance Wordpress and Node.js Developer | William Youmans';
