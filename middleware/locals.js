...
module.exports = function() {
  return function(req, res, next) {
    ...
    res.locals.metaDescription = 'Discover how a professional freelance web developer in NEPA, Wilkes-Barre, Scranton, Hazelton, Philadelphia Pennsylvania can improve your website to boost your customer base.';
